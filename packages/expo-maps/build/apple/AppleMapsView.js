 ...
 * @platform ios
 */
export const AppleMapsView = React.forwardRef(({ onMapClick, onMarkerClick, onCameraMove, onPolylineClick, onCircleClick, onPolygonClick, onAnnotationClick, annotations, polylines, circles, polygons, ...props }, ref) => {
